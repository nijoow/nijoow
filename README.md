...
- 전공에서 학습한 기초적인 디자인과 프로그래밍을 바탕으로 웹 개발을 독학하고 있으며, 꾸준히 새로운 지식을 습득하려고 노력하 고 있습니다.
- UI/UX와 디자인을 중요하게 생각하여 기능 뿐만 아니라 사용자가 보고 느끼기에도 좋은 웹페이지를 만드는 실력 있는 개발자가 되는 것을 목표로 하고 있습니다.
<br/>  
